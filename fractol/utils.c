...
/*   Updated: 2024/08/21 18:29:25 by amasiuk          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	mlx_funcs(t_data *data)
{
	...
	data->win = mlx_new_window(data->disp, WIDTH, HEIGHT, data->name);
	if (data->win == NULL)
	...
	mlx_hook(data->win, DestroyNotify, ButtonReleaseMask, quit, data);
